...
setup(
    name="Foris SSBackups Plugin",
    version="8.4",
    description="SSBackups plugin for foris web interfce",
    author="CZ.NIC, z. s. p. o.",
    author_email="stepan.henek@nic.cz",
    url="https://gitlab.labs.nic.cz/turris/foris/foris-ssbackups-plugin/",
    license="GPL-3.0",
    install_requires=[
